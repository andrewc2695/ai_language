...
//    - **CRITICAL:** You must provide an object of words with their success status in the updateWordProgress tool call.
//    - The object must have the following structure:
//    - {
//    -   "words": [
//    -     {
//    -       "english": "i / me",
//    -       "cantonese_jyutping": "ngo5",
//    -       "success": true
//    -     }
//    -   ]
//    - }
...
export const SentenceAgent = () => {
    ...
    return new Agent({
        ...
        instructions: "You are a cantonese language teacher, you generate sentences in jyutping for the user to practice their cantonese language skills.",
        tools: {
